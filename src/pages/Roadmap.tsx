    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="hero-gradient py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="text-lg bg-white/10 backdrop-blur-sm rounded-lg p-4 inline-block">
              ...
              <div key={step.step} className="relative">
                ...
                <div className="flex flex-col md:flex-row gap-8 items-start">
                  ...
                  <div className="flex-shrink-0 relative z-10">
                    <div className="w-16 h-16 bg-primary rounded-full flex items-center justify-center text-white font-bold text-xl shadow-elegant">
                      {step.step}
                    </div>
                    <div className="mt-4 w-16 h-16 bg-primary/10 rounded-full flex items-center justify-center">
